...
作成日: 2026-09-03 / 状態: **v1 完成（起票した Issue はすべて完了）。手順書は `docs/SETUP.md`、提出情報は `README.md`**
...
| #26 | Tailwind CSS のビルド基盤と Noto Sans JP |
...
| #38 | 投稿・編集画面の画像プレビュー |
| #43 | 提出前の最終整備（README・設計書の最終化、clone 直後の再確認） |
