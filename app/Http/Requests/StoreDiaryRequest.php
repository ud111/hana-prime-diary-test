...
class StoreDiaryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'image' => ['bail', 'nullable', 'file', 'mimes:jpg,jpeg', 'mimetypes:image/jpeg', 'max:'.Diary::IMAGE_MAX_KB, 'dimensions:max_width='.DiaryImageProcessor::MAX_DIMENSION.',max_height='.DiaryImageProcessor::MAX_DIMENSION],
        ];
    }
